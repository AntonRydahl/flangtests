...
define void @_QFPmult_scalar(ptr nocapture writeonly %0, ptr nocapture readonly %1) local_unnamed_addr #1 {
...
attributes #1 = { nofree nosync nounwind memory(read, argmem: readwrite, inaccessiblemem: none) }
