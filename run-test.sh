...
~/flang_install/build/bin/flang-new -S -emit-llvm "./$1/test.f90" -o "./$1/fbin/test.ll"
~/flang_install/build/bin/flang-new -S -emit-llvm "./$1/test.f90" -O2 -o "./$1/fbin/test_O2.ll"
~/flang_install/build/bin/flang-new -S -emit-llvm "./$1/test.f90" -O3 -o "./$1/fbin/test_O3.ll"
