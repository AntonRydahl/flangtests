...
@_QQro.3xi4.04c00a9141e27c6cf826ab1893306503 = internal constant [3 x i32] [i32 17, i32 27, i32 37]
@_QQro.3xi4.00fe3bc99cd7b2a3a9636bdd9122707e = internal constant [3 x i32] [i32 44, i32 55, i32 66]
@_QQcl.2E2F2E2F6164645F6172726179735F746573742F746573742E66393000 = linkonce constant [29 x i8] c"././add_arrays_test/test.f90\00"
...
9:                                                ; preds = %5
  ...
  %13 = mul i64 %12, 1
  %14 = add i64 %13, 0
  %15 = getelementptr i32, ptr @_QQro.3xi4.04c00a9141e27c6cf826ab1893306503, i64 %14
...
28:                                               ; preds = %24
  ...
  %32 = mul i64 %31, 1
  %33 = add i64 %32, 0
  %34 = getelementptr i32, ptr @_QQro.3xi4.00fe3bc99cd7b2a3a9636bdd9122707e, i64 %33
...
67:                                               ; preds = %42
  %68 = call ptr @_FortranAioBeginExternalListOutput(i32 -1, ptr @_QQcl.2E2F2E2F6164645F6172726179735F746573742F746573742E66393000, i32 7)
